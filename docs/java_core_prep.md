...
* [Как работать со строками в `Java`](#как-работать-со-строками-в-java)
* [Как работать с `regex` в `Java`](#как-работать-с-regex-в-java)
...
### 1. Использование методов `getter` и `setter`:
